...
- [Configuring the ChatGPT Action](Configuring-the-ChatGPT-Action)
...
- [Technical docs](https://github.com/aferende/ha-chatgpt-gateway/tree/main/docs)
- [Security](https://github.com/aferende/ha-chatgpt-gateway/blob/main/docs/security.md)
